...
<html>
    ...
    <body>
        ...
        <h1>角色管理</h1>
        <a href="<%=response.encodeURL("role-create.jsp")%>"><button type="button" class="add">增加</button></a>
        <table class="table table-hover" style="width: 1024px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a
                            href="<%=response.encodeURL("role-update.jsp?name=" + rs.getString("name"))%>"><button
                                type="button" class="update">修改</button></a><a href="<%=response.encodeURL("role-delete.jsp?name=" + rs.getString("name"))%>"><button
