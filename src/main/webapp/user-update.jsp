...
<html>
    ...
    <body>
        ...
        %>
        <form method="post" action="<%=response.encodeURL("user-update-process.jsp")%>">
            <table border="1">
                <tr >
                    <th><b>用户名</b></th>
                    <th><b>密码</b></th>
                ...
                <tr>
                    ...
                    <td><input readonly style="text-align: center" type="text"
                               name="username" value="<%=StringEscapeUtils.escapeHtml4(rs.getString("username"))%>">
                    </td>

                    <td><input style="text-align: center" type="password"
